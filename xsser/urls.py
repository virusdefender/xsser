...
urlpatterns = patterns('',
    ...
    url(r'^record/delete', 'core.views.delete_record', name="delete_record"),
    ...
    url(r'^project/settings/(?P<project_id>\w+)/$', 'core.views.project_settings', name="project_settings"),
